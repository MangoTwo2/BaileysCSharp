...
namespace BaileysCSharp.Core.WABinary
{
    ...
    public static class Constants
    {
        ...
        public const string DEFAULT_ORIGIN = "https://web.whatsapp.com";
    ...
    StubType.GroupParticipantAdd,
        ...
        public static class TAGS
        {
            ...
            public const int DICTIONARY_0 = 236;
            public const int DICTIONARY_1 = 237;
            public const int DICTIONARY_2 = 238;
            public const int DICTIONARY_3 = 239;
            public const int INTEROP_JID = 245;
            public const int FB_JID = 246;
            public const int AD_JID = 247;
            public const int LIST_8 = 248;
            public const int LIST_16 = 249;
            public const int JID_PAIR = 250;
            public const int HEX_8 = 251;
            public const int BINARY_8 = 252;
            public const int BINARY_20 = 253;
            public const int BINARY_32 = 254;
            public const int NIBBLE_8 = 255;
            public const int PACKED_MAX = 127;
        ...
        public const string DEF_TAG_PREFIX = "TAG:";
        public const string S_WHATSAPP_NET = "@s.whatsapp.net";


        public static string[] SINGLE_BYTE_TOKENS =
        {
        ...
        static Constants()
        {
            ...
            {
                TOKEN_MAP[SINGLE_BYTE_TOKENS[i]] = new Dictionary<string, int> { { "index", i } };
            }

            for (int i = 0; i < DOUBLE_BYTE_TOKENS.Length; i++)
            {
                for (int j = 0; j < DOUBLE_BYTE_TOKENS[i].Length; j++)
                {
                    TOKEN_MAP[DOUBLE_BYTE_TOKENS[i][j]] = new Dictionary<string, int> { { "dict", i }, { "index", j } };
                }
            }
        }


        public static Dictionary<string, string> MEDIA_HKDF_KEY_MAPPING = new Dictionary<string, string>()
        {
            {"audio", "Audio" },
            {"document", "Document" },
            {"gif", "Video" },
